...
func (u *UserService) AddUser(user *User) *UserResponse {
	...
	var addURL = u.Host + "/rs/client/user/add"
...
func (u *UserService) UpdateUser(user UpdateUser) *UserResponse {
	var rtn = new(UserResponse)
	var upURL = u.Host + "/rs/client/user/update"
...
// GetUser get
func (u *UserService) GetUser(username string) *User {
	var rtn = new(User)
	var gURL = u.Host + "/rs/client/user/get/" + username
	//fmt.Println(gURL)
...
// 	var rtn = make([]User, 0)
// 	var gURL = u.Host + "/rs/client/user/list"
// 	//fmt.Println(gURL)
// 	req, rErr := http.NewRequest("GET", gURL, nil)
// 	if rErr != nil {
// 		fmt.Print("request err: ")
...
func (u *UserService) SearchUserList() *[]User {
	var rtn = make([]User, 0)
	var gURL = u.Host + "/rs/client/user/search"
	fmt.Println(gURL)
	req, rErr := http.NewRequest("GET", gURL, nil)
	if rErr != nil {
		fmt.Print("request err: ")
...
// DeleteUser delete
func (u *UserService) DeleteUser(username string) *UserResponse {
	var rtn = new(UserResponse)
	var gURL = u.Host + "/rs/client/user/delete/" + username
	//fmt.Println(gURL)
